...
import com.RapidGrill.service.RestaurantService;
...
public class RestaurantController {
    ...
    public ResponseEntity<List<Restaurant>> searchRestaurant(@RequestHeader("Authorization") String jwt,
        ...
        List<Restaurant> restaurant = restaurantService.searchRestaurants(name);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Restaurant> getAllRestaurant(@RequestHeader("Authorization") String jwt,
    ...
    public ResponseEntity<RestaurantDto> addToFavorite(@RequestHeader("Authorization") String jwt,
        ...
        RestaurantDto restaurant = restaurantService.addToFavaourites(id, user);
